 ...
 *
 */
void data_transform(const INT nv, const INT m, REAL* data, REAL* xodst, REAL* xndst) {
  INT i, j;
 ...
 *
 */
void interp1(const INT dimbig, REAL* fi, unigrid* ug, REAL* x, const INT nvert, INT* mask) {
  /*
