/*! \file src/amr/features.c
 *
 *  Created by James Adler, Xiaozhe Hu, and Ludmil Zikatanov on 20170715.
 *  Copyright 2017__HAZMATH__. All rights reserved.
 *
 *  \note: routines to read csv files exported from excel with special
 *  symbols in them
 *
 * uses the build-in qsort from stdlib
 */
#include "hazmath.h"
...
/***************************************************/
  ...
  */ 
  ...
  fclose(feat->fpf);
  //  fclose(feat->fpf);
  /* sort so that duplicates are together */
