...
% load AMG package
%addpath(genpath('~/UAAMG'));
%addpath(genpath('~/PathAMG'));
...
%load('loc-gowalla_edges_Lg_comp.mat') 
...
% AMG parameters
%---------------------
amgParam.print_level = 0; % how much information to print when using AMG solve only
                          % 0: print nothing | positive number print information  
% setup phase parameters
amgParam.max_level = 15; % maximal number of level in AMG
...
amgParam.max_it = 1600;  % when AMG is used as standalone solver, maximal number of iterations that is allowed
...
%---------------------
iterParam.solver_type = 'AMG_path'; % 'SL': GS as standalone solver | 'AMG': AMG as standalone solver 
...
iterParam.max_it = 1500; % maximal number of iterations that is allowed
