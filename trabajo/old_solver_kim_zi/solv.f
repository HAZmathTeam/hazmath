...
cc      parameter (nlast = 140 000 000, nrlast = 100 000 000)  !limit
      parameter (nlast = 1 625 000, nrlast = 1 500 000)  !lvl = 8
cc      parameter (nlast = 6 500 000, nrlast = 6 000 000)  !lvl = 9
cc      parameter (nlast = 26 000 000, nrlast = 24 000 000)  !lvl = 10
...
C...             1 - writing the computed exact soln;
...
C
      ...
      maxitr = 0
C
      call read_param(lsolve,tol,maxitr,iformatted)
cc      call read_param_multi(lsolve,tol,maxitr,iformatted,kk,jj)
