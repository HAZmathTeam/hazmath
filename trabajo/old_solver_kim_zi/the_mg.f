...
C
     ...
     >     iordk,iend ,kwk1,kend,n,max_iter,itmax,iexact,
     >     iac,jac,iordc,kuc,kac,jiter,jptk,nnz,nnzc,kfrold,ifrold
      integer iaw,jaw,isub,iwork1,iwork2,iwork3,nblk,nh
      common /onezero/ zero,one
C---------------------------------------------------------------------
C...  MG_MATCH stands for an multigrid algorithm, and it performs
