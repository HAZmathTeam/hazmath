...
C=====================================================================
      ...
      dimension iord(1),ia(1),ja(1),iaw(1),jaw(1),isub(1),
     >     lwork1(1),lwork2(1),lwork3(1)
      dimension a(1)
C---------------------------------------------------------------------
C...  
C---------------------------------------------------------------------
...
C======================================================================
      ...
      integer*4 lowlink(1),edgeptr(1),lstack_number(1)
cc      integer*4 q(1)
C---------------------------------------------------------------------
...
C====================================================================
      implicit real*8(a-h,o-z)
      integer*4 iord(1),ia(1),ja(1),iat(1),jat(1),n,m
...
C====================================================================
      subroutine orde(ia,ja,an,n,m,iat,jat,ant)
C====================================================================
      implicit real*8(a-h,o-z)
      integer*4 iord(1),ia(1),ja(1),iat(1),jat(1),n,m
      dimension an(1),ant(1)
C---------------------------------------------------------------------
C...  Convert from RRCU to RRCO.
C---------------------------------------------------------------------
      call aat(iord,ia,ja,an,n,m,iat,jat,ant)
      call aat(iord,iat,jat,ant,m,n,ia,ja,an)
      return
      end
C=====================================================================
