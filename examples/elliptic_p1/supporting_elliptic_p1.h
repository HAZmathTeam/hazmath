 ...
 */
/******************************************************************************/
static void symb_assembly(INT ns, INT ndof, INT ndofloc, INT* je, INT** ia_out, INT** ja_out, INT* iess) {
 ...
 *
 */
static void assemble_matrix(INT ndof, INT* ia, INT* ja, INT ndofloc, INT* jeloc, REAL* a, REAL* aloc, INT* iess, INT* ip) {
 ...
 *
 */
static void assemble_rhs(INT ndof, INT ndofloc, INT* jeloc, REAL* rhs, REAL* rhsloc) {
  INT i, l;
  for (l = 0; l < ndofloc; ++l) {
    i = jeloc[l];
 ...
 *
 */
static void set_essential_bc(INT ndof, INT* ia, INT** ja_out, REAL** a_out, REAL* rhs, INT* iess) {
  INT ij, i, j, nnz, ia0;
  INT* ja = ja_out[0];
  REAL* a = a_out[0];
 ...
 */
/**********************************************************************************/
static void call_assembly(scomplex* sc, dCSRmat* A, dvector* rhs, const REAL alpha, const REAL gamma) {
 ...
 */
/**********************************************************************************/
static void call_assembly_w_dg(scomplex* sc, dCSRmat* A, dvector* rhs, const REAL alpha, const REAL gamma) {
  REAL fi;
