...
C
      ...
      ich(8) = 4      !the number of subdomains, 1, 2, or 4.
      ich(9) = 3      !the coarse level of the two-grid algorithm, 3,4,5,6,7.
C
C...  Quadrature for integrations:
C
...
C
      ...
      if(iread .eq. 1) then
         ...
         open(123,file='in_dd',status='unknown')
         read(123,*) ich(9)
         read(123,*) ich(32)
         read(123,*) ich(33)
         read(123,*) ich(34)
