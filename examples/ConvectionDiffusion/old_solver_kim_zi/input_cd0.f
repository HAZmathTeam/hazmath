...
C
      ...
      ich(39) = 5000  !maximum number of MG iterations
      ich(40) = 1     !choice of the stiffness matrix (iterator B) in MG.
      ich(41) = 0     !Tarjan's ordering is considered, set it to be 1.
C
      iread = 1
