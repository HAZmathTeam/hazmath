...
C...              11 = fwd G-S on 1st order stable scheme, e.g., EAFE,
C...              12 = bwd G-S on 1st order stable scheme, e.g., EAFE,
C...              13 = sym G-S on 1st order stable scheme, e.g., EAFE,
C...              14 = Gauss elim on 1st order stable scheme, e.g., EAFE,
C...              21 = fwd G-S on 2nd order scheme, e.g., Galerkin,
C...              22 = bwd G-S on 2nd order scheme, e.g., Galerkin,
C...              23 = sym G-S on 2nd order scheme, e.g., Galerkin,
C...              24 = Gauss elim on 2nd order scheme, e.g., Galerkin,
...
C...    ich(42) - choice of G-S smoothing in the normal eq:
C...              1 = fwd G-S, 2 = bwd G-S, 3 = sym G-S
C...    ich(43) - number of G-S smoothing in the normal eq: 1,2,3, etc
C...
...
C
      ...
      ich(7) = 5      !Solver of the linear system 
C
C...  Quadrature for integrations:
C
...
C...  Functions:
C
      ich(21) = 4 !23789     !Leading term: a scalar function, EPS(x,y)
      ich(22) = 1     !Leading term: a matrix function, ALPHA(i,j,x,y) 
      ich(23) = 1     !Format of the convection term
      ich(24) = 2 !2910     3-Laplace !Convection term: BETA, when ich(23) = 1
...
C
      ...
      ich(33) = 2     !choice of post-smoothing: 
      ...
      ich(38) = 14    !choice of the coarsest grid solver: 
      ...
      ich(42) = 1     !choice of G-S smoothing in the normal eq:
      ich(43) = 1     !number of G-S smoothing in the normal eq:
C
      iread = 1
