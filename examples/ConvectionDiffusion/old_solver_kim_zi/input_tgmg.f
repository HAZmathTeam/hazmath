...
C...    ich(8)  - the number of multilevel step
C...
...
C...
C...  Multilevel: To control the multilevel version of two-grid method
C...    ich(41) - the coarsest level
C...    ich(42),..., ich(ich(8)) - next levels
...
C
      ...
      ich(8) = 2      !the number of multilevel step
C 
C...  Quadrature for integrations:
C
...
C
      ...
      ich(39) = 30    !maximum number of MG iterations
C
C...  Multilevel
C
      ich(41) = 4     !the coarsest level:
      ich(42) = 10     !next level
      ich(43) = 11    !next level
      ich(44) = 0     !next level
      ich(45) = 0     !next level
      ich(46) = 0     !next level
      ich(47) = 0     !next level
