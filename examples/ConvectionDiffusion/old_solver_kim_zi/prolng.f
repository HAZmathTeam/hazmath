C=====================================================================
      subroutine prolng_symb(nxf,nyf,nf,nxc,nyc,nc,ipp,jpp,np)
C=====================================================================
      dimension ipp(1),jpp(1)
C---------------------------------------------------------------------
C...  Symbolic assembly of a prolongation matrix for uniform meshes
C...  on a rectangular domain. No numerical value is stored. Ordering 
C...  of the grid points is given as follows: start from left bottom 
C...  corner, go upward in y direction, and do the same way for the 
C...  following columns.
C...
C...  Input:
...
C=====================================================================
      subroutine pbyvg(ipp,jpp,b,nc,c,nf)
C=====================================================================
      implicit real*8 (a-h,o-z)
      dimension ipp(1),jpp(1),b(nc),c(nf)
C--------------------------------------------------------------------
C...  PRODUCT - Prolongation: c = P*b on the structured uniform grid
C--------------------------------------------------------------------
      do 10 i = 1, nf
         ipa = ipp(i)
         ipb = ipp(i+1) - 1
...
C=====================================================================
      subroutine pbyvcs(ipp,jpp,b,nc,c,nf)
C=====================================================================
      implicit real*8 (a-h,o-z)
      dimension ipp(1),jpp(1),b(nc),c(nf)
C--------------------------------------------------------------------
C...  PRODUCT - Vector + Prolongation: c = c + P*b on the structured 
C...            uniform grid
C--------------------------------------------------------------------
      do 10 i = 1, nf
         ipa = ipp(i)
...
C=====================================================================
      subroutine pbyvcm(ipp,jpp,b,nc,c,nf)
C=====================================================================
      implicit real*8 (a-h,o-z)
      dimension ipp(1),jpp(1),b(nc),c(nf)
C--------------------------------------------------------------------
...
C=====================================================================
      subroutine pbyvas(a,ipp,jpp,b,nc,c,nf)
C=====================================================================
      implicit real*8 (a-h,o-z)
      dimension ipp(1),jpp(1),b(nc),c(nf),a(nf)
C--------------------------------------------------------------------
C...  PRODUCT - Vector + Prolongation: c = a + P*b on the structured 
C...            uniform grid
C--------------------------------------------------------------------
      do 10 i = 1, nf
         ipa = ipp(i)
...
C=====================================================================
      subroutine pbyvam(a,ipp,jpp,b,nc,c,nf)
C=====================================================================
      implicit real*8 (a-h,o-z)
      dimension ipp(1),jpp(1),b(nc),c(nf),a(nf)
C--------------------------------------------------------------------
...
C=====================================================================
      subroutine rvbyp(ipp,jpp,b,nf,c,nc)
C=====================================================================
      implicit real*8 (a-h,o-z)
      dimension ipp(1),jpp(1),b(nf),c(nc)
C--------------------------------------------------------------------
C...  PRODUCT - Restriction: c = b^t*P = P^t*b on the structured
C...            uniform grid
C--------------------------------------------------------------------
      do 10 i = 1, nc
         c(i) = 0.0d00
...
C=====================================================================
      subroutine abyp(ia,ja,ipp,jpp,np,ic,jc,an,cn,x,nq)
C=====================================================================
      implicit real*8 (a-h,o-z)
...
C...  matrix A : C = A*P  on the structured uniform grid.
C--------------------------------------------------------------------
      do i  = 1 , np
         ica = ic(i) 
         icb = ic(i+1) - 1
