...
void local_assembly_Elasticity_FACE(block_dCSRmat* A, block_fespace *FE, mesh_struct *mesh, qcoordinates *cq, INT face)
{
...
int main (int argc, char* argv[])
{
  ...
  */
  ...
  assemble_global_block_neighbor(&A,&b,local_assembly_Elasticity_FACE,local_assembly_Elasticity,FEM_Block_RHS_Local_Elasticity,&FE,&mesh,cq,source2D,0.0);
