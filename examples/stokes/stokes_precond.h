 ...
 */
  ...
  *
  */
 static precond_block_data *get_precond_block_data_stokes(block_dCSRmat *Ab,
                                                          dCSRmat *Mp,
                                                          ...
                                                          AMG_param *amgparam)
{
  ...
  * \date   08/24/2021
  */
 static void precond_block_diag_stokes(REAL *r,
                                REAL *z,
                                void *data)
 {
  ...
  * \date   08/24/2021
  */
 static void precond_block_diag_stokes_krylov(REAL *r,
                                       REAL *z,
                                       void *data)
 {
   precond_block_data *precdata=(precond_block_data *)data;
  ...
  * \date   08/24/2021
  */
 static void precond_block_lower_stokes(REAL *r,
                                 REAL *z,
                                 void *data)
 {
   precond_block_data *precdata=(precond_block_data *)data;
  ...
  * \date   08/24/2021
  */
 static void precond_block_lower_stokes_krylov(REAL *r,
                                        REAL *z,
                                        void *data)
 {
   precond_block_data *precdata=(precond_block_data *)data;
  ...
  * \date   08/24/2021
  */
 static void precond_block_upper_stokes(REAL *r,
                                 REAL *z,
                                 void *data)
 {
   precond_block_data *precdata=(precond_block_data *)data;
  ...
  * \date   08/24/2021
  */
 static void precond_block_upper_stokes_krylov(REAL *r,
                                        REAL *z,
                                        void *data)
 {
   precond_block_data *precdata=(precond_block_data *)data;
